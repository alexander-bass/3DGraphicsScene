...
{	public Utils() {}
	...
	// plaster material
	public static float[] plasterAmbient()  { return (new float [] {0.19f, 0.18f, 0.17f, 1.0f} ); }
	public static float[] plasterDiffuse()  { return (new float [] {0.90f, 0.89f, 0.85f, 1.0f} ); }
	public static float[] plasterSpecular() { return (new float [] {0.05f, 0.05f, 0.05f, 1.0f} ); }
	public static float plasterShininess()  { return 2f; }
}